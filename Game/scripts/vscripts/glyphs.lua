...
function Glyphs:GetRandomHeronameForBook()
	local heroNameTable = {"sorceress", "axe", "trapper", "duskbringer", "venomort", "paladin", "astral", "flamewaker", "epoch"}
...
function Glyphs:GetAvailableColumnCount(rpcHeroName)
	...
	if rpcHeroName == "neutral" then
		columns = 3
	elseif rpcHeroName == "sorceress" or rpcHeroName == "axe" or rpcHeroName == "trapper" or rpcHeroName == "duskbringer" or rpcHeroName == "venomort" or rpcHeroName == "paladin" or rpcHeroName == "astral" or rpcHeroName == "flamewaker" or rpcHeroName == "epoch" then
		columns = 2
	end
	return columns
end
