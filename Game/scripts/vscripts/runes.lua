...
function Runes:EquipArcana(hero, index)
	...
	elseif hero:GetUnitName() == "npc_dota_hero_antimage" then
		if index == 1 then
			...
			Runes:EasySwapArcanaSkills(hero, 0, "arkimus_dimension_coil", "arkimus_zap_ring", HerosCustom:GetInternalHeroName(hero:GetUnitName()), "arcana1")
		elseif index == 2 then
...
function Runes:UnequipArcana(hero, index)
	...
	elseif hero:GetUnitName() == "npc_dota_hero_antimage" then
		if index == 1 then
			...
			Runes:EasyRevertArcanaSkills(hero, 0, "arkimus_dimension_coil", "arkimus_zap_ring", HerosCustom:GetInternalHeroName(hero:GetUnitName()), "arcana1")
		elseif index == 2 then
