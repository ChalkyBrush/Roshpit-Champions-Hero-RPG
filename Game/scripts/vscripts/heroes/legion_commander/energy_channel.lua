...
function protector_c_b_zap(event)
	...
	local caster = event.caster
	local ability = event.ability
	local c_b_damage = OverflowProtectedGetAverageTrueAttackDamage(caster) * MOUNTAIN_PROTECTOR_W3_PCT/100 * ability.w_3_level + caster:GetMaxHealth() * MOUNTAIN_PROTECTOR_W3_HP_PART_PCT/100 * ability.w_3_level
