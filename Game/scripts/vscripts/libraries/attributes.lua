...
function Attributes:ModifyBonuses(hero)
    ...
    Timers:CreateTimer(function()
        ...
        if hero:HasModifier("modifier_halcyon_soul_glove") then
            armor = armor + agility * Attributes.v.ARMOR_PER_AGI * ITEM_RPC_HALCYON_SOUL_GLOVE_BONUS
        end
        ...
        if strength ~= hero.strength then
            ...
            if hero:HasModifier("modifier_halcyon_soul_glove") then
                health_stacks = health_stacks + strength * Attributes.v.HP_PER_STR * ITEM_RPC_HALCYON_SOUL_GLOVE_BONUS
            end
            ...
            if hero:HasModifier("modifier_halcyon_soul_glove") then
                health_regen_stacks = health_regen_stacks + strength * Attributes.v.HP_REGEN_PER_STR * ITEM_RPC_HALCYON_SOUL_GLOVE_BONUS
            end
        ...
        if intellect ~= hero.intellect then
            ...
            --print(mana_stacks)
            if hero:HasModifier("modifier_halcyon_soul_glove") then
                mana_stacks = mana_stacks - intellect * Attributes.v.MANA_PER_INT * ITEM_RPC_HALCYON_SOUL_GLOVE_BONUS
            end
            --print("MANA STACKS B:")
            --print(mana_stacks)
            ...
            if hero:HasModifier("modifier_halcyon_soul_glove") then
                mana_regen_stacks = mana_regen_stacks + intellect * Attributes.v.MANA_REGEN_PER_INT * ITEM_RPC_HALCYON_SOUL_GLOVE_BONUS
            end
