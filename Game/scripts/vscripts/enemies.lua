...
function Enemies:SplitAdjustedEXP(exp, number_of_heroes)
	-- ╔══════════════════════╦════════╦══════════════════╦═════════════════════╦═════════════════════╗
	-- ║ EXP_SHARE_PERCENTAGE ║ 1 Hero ║ 2 Heroes         ║ 3 Heroes            ║ 4 Heroes            ║
	-- ╠══════════════════════╬════════╬══════════════════╬═════════════════════╬═════════════════════╣
	-- ║ 0.95                 ║ 100%   ║ 95% -> 190%      ║ 90.25% -> 270.75%   ║ 85.7375% -> 342.95% ║
	-- ║ 0.90                 ║ 100%   ║ 90% -> 180%      ║ 81%    -> 243%      ║ 72.9%    -> 291.6%  ║
	-- ║ 0.85                 ║ 100%   ║ 85% -> 170%      ║ 72.25% -> 216.75%   ║ 61.4125% -> 245.65% ║
	-- ║ 0.80                 ║ 100%   ║ 80% -> 160%      ║ 64%    -> 192%      ║ 51.2%    -> 204.8%  ║
	-- ╠══════════════════════╬════════╬══════════════════╬═════════════════════╬═════════════════════╣
	-- ║ 0.75 <- CURRENT      ║ 100%   ║ 75% -> 150%      ║ 56.25% -> 168.75%   ║ 42.1875% -> 168.75% ║
	-- ╠══════════════════════╬════════╬══════════════════╬═════════════════════╬═════════════════════╣
	-- ║ 0.70                 ║ 100%   ║ 70% -> 140%      ║ 49%    -> 147%      ║ 34.3%    -> 137.2%  ║
	-- ║ 0.65                 ║ 100%   ║ 65% -> 130%      ║ 42.25% -> 126.75%   ║ 27.4625% -> 109.85% ║
	-- ║ 0.60                 ║ 100%   ║ 60% -> 120%      ║ 36%    -> 108%      ║ 21.6%    -> 86.4%   ║
	-- ╚══════════════════════╩════════╩══════════════════╩═════════════════════╩═════════════════════╝
