...
Enemies.DIFFICULTY_ROSHPIT_ATTRIBUTE_ADJUST[DIFFICULTY_ELITE][ENEMY_TYPE_BOSS] = 3
Enemies.DIFFICULTY_ROSHPIT_ATTRIBUTE_ADJUST[DIFFICULTY_ELITE][ENEMY_TYPE_MAJOR_BOSS] = 3
Enemies.DIFFICULTY_ROSHPIT_ATTRIBUTE_ADJUST[DIFFICULTY_LEGEND][ENEMY_TYPE_WEAK_CREEP] = 3
Enemies.DIFFICULTY_ROSHPIT_ATTRIBUTE_ADJUST[DIFFICULTY_LEGEND][ENEMY_TYPE_NORMAL_CREEP] = 3
Enemies.DIFFICULTY_ROSHPIT_ATTRIBUTE_ADJUST[DIFFICULTY_LEGEND][ENEMY_TYPE_ELITE_CREEP] = 3
Enemies.DIFFICULTY_ROSHPIT_ATTRIBUTE_ADJUST[DIFFICULTY_LEGEND][ENEMY_TYPE_MINI_BOSS] = 4
...
Enemies.DIFFICULTY_PIERCE_ADJUST[DIFFICULTY_LEGEND] = 1
...
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT = {}
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_NORMAL] = {}
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_ELITE] = {}
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_LEGEND] = {}
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_NORMAL][ENEMY_TYPE_WEAK_CREEP] = 0.33
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_NORMAL][ENEMY_TYPE_NORMAL_CREEP] = 0.4
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_NORMAL][ENEMY_TYPE_ELITE_CREEP] = 0.46
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_NORMAL][ENEMY_TYPE_MINI_BOSS] = 0.53
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_NORMAL][ENEMY_TYPE_BOSS] = 0.60
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_NORMAL][ENEMY_TYPE_MAJOR_BOSS] = 0.66
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_ELITE][ENEMY_TYPE_WEAK_CREEP] = 0.5
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_ELITE][ENEMY_TYPE_NORMAL_CREEP] = 0.6
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_ELITE][ENEMY_TYPE_ELITE_CREEP] = 0.7
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_ELITE][ENEMY_TYPE_MINI_BOSS] = 0.8
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_ELITE][ENEMY_TYPE_BOSS] = 0.9
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_ELITE][ENEMY_TYPE_MAJOR_BOSS] = 1
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_LEGEND][ENEMY_TYPE_WEAK_CREEP] = 0.75
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_LEGEND][ENEMY_TYPE_NORMAL_CREEP] = 0.9
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_LEGEND][ENEMY_TYPE_ELITE_CREEP] = 1.05
Enemies.DIFFICULTY_ARCANE_CRYSTALS_MULT[DIFFICULTY_LEGEND][ENEMY_TYPE_MINI_BOSS] = 1.2
...
Enemies.SERENGAARD_BUFFS_PER_WAVE["roshpit_armor"] = 0.02
Enemies.SERENGAARD_BUFFS_PER_WAVE["roshpit_magic_armor"] = 0.02
Enemies.SERENGAARD_BUFFS_PER_WAVE["roshpit_armor_pierce"] = 0.02
Enemies.SERENGAARD_BUFFS_PER_WAVE["roshpit_spell_pierce"] = 0.02
...
function Enemies:AdjustAttributeForMapSpecial(enemy, attribute_type, base_attribute_value)
	...
	elseif GameState:IsSerengaard() then
		if Serengaard.InfiniteWaveCount then
			if attribute_type == "arcane_crystals" then
...
Enemies.PARAGON_EXCEPTION_TABLE = {"pixie_minion", "npc_dummy_unit", "winterblight_zefnar", "npc_flying_dummy_vision", "water_temple_tentacle_switch", "ekkan_corpse", "tanari_wind_spark_dummy", "azalea_maze_food", "conquest_forest_guide", "arena_cliff_spirit", "treasure_goblin_rpc_redfall_ridge", "treasure_goblin_rpc_tanari_jungle", "treasure_goblin_rpc_winterblight_mountain", "treasure_goblin_rpc_roshpit_arena", "treasure_goblin_rpc_sea_fortress", "winterblight_mountain_tombstone", "winterblight_merkurio", "winterblight_puck_guard", "winterblight_altar_of_ice_apparition"}
