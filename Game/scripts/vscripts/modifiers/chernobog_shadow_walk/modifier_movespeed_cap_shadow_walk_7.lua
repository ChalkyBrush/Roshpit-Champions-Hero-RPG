...
function modifier_movespeed_cap_shadow_walk_7:GetModifierMoveSpeed_AbsoluteMax( params )
    return 700
end
...
function modifier_movespeed_cap_shadow_walk_7:GetModifierIgnoreMovespeedLimit()
    return 1
end