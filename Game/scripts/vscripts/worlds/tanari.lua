...
function Tanari:Debug()
    ...
    -- Glyphs:DebugRollHeroGlyphs("slipfinn", Vector(-4928, 2048))
   ...
   -- RPCItems:RollNightmareRiderMantle(Vector(-4928, 2048))
    ...
    -- Weapons:RollLegendWeapon2(Vector(-4928, 2048), "slipfinn")
    -- Weapons:RollLegendWeapon3(Vector(-4928, 2048), "slipfinn")
    ...
    -- Glyphs:RollGlyphAll("item_rpc_hydroxis_glyph_4_1", Vector(-4928, 2048), 0)
