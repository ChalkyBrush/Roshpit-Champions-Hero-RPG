...
function Tanari:Debug()
    ...
    RPCItems:RollStormclothBracer(Vector(-4928, 2048))
    RPCItems:RollHurricaneVest(Vector(-4928, 2048))
    RPCItems:RollBrazenKabuto(Vector(-4928, 2048), false)
    RPCItems:RollElderGrasp(Vector(-4928, 2048))
    ...
    -- Arena = {}
    -- Arena.PitLevel = 7
    -- Weapons:RollLegendWeapon1(Vector(-4928, 2048), "venomort")
