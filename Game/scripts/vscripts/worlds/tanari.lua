...
function Tanari:Debug()
    ...
    -- RPCItems:RollAndDropUniqueItem(unit, "item_rpc_giant_hunters_boots_of_resilience")
    ...
    local helm = RPCItems:RollAndDropImmortalByLevel(MAIN_HERO_TABLE[1]:GetAbsOrigin(), 60, "item_rpc_giant_hunters_boots_of_resilience")

    helm = Gems:AddSocket(helm)
    helm = Gems:AddSocket(helm)

    local helm = RPCItems:RollAndDropImmortalByLevel(MAIN_HERO_TABLE[1]:GetAbsOrigin(), 1, "item_rpc_giant_hunters_boots_of_resilience")
