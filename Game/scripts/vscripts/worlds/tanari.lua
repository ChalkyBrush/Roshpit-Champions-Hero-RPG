...
function Tanari:Debug()
    ...
    local arcana = RPCItems:RollFlamewakerArcana1(1)
    ...
    -- local internalHeroName = HerosCustom:GetInternalHeroNameMain(MAIN_HERO_TABLE[1]:GetClassname())
    -- Weapons:RollLegendWeapon3(Vector(-4928, 2048), internalHeroName)
    -- Weapons:RollJexLegendWeapon2a(Vector(-4928, 2048), false) 
