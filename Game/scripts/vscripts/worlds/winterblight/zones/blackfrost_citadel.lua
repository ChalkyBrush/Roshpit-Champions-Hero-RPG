...
function Winterblight:SetupCastleData()
		...
		Winterblight.CASTLE_DATA["tarot"][17]["rooms"][4] = {index = 12, variant = 1}
		...
		Winterblight.CASTLE_DATA["tarot"][18]["rooms"][4] = {index = 10, variant = 1}
		...
		Winterblight.CASTLE_DATA["rooms"][6]["extra_goal"] = -1
		...
		Winterblight.CASTLE_DATA["rooms"][8]["extra_goal"] = 14
		...
		Winterblight.CASTLE_DATA["rooms"][10]["extra_goal"] = -1
...
function Winterblight:SpawnTreasureRoomChests()
	...
	local crystals_count = (RandomInt(34, 40 + GameState:GetPlayerPremiumStatusCount()*4))/40
...
function Winterblight:CastleBossDeath(boss)
	...
	Timers:CreateTimer(6, function()
		...
		local vessel_bonus = 0
			if vessel_luck = 1 then
			vessel_bonus = 1
			elseif vessel_luck = 2 then
			vessel_bonus = 2
			end
