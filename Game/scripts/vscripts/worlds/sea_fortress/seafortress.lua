...
function Seafortress:Debug()
  if MAIN_HERO_TABLE[1] then
    ...
    MAIN_HERO_TABLE[1]:CalculateStatBonus(true)
  end
...
function Seafortress:Init()
  ...
  Timers:CreateTimer(4, function()
    Soulbinder:SpawnSoulbinder(Vector(1065, -15960), Vector(-0.3, 1))
  end)
...
function Seafortress:FirstPirateRoom()
  ...
  for i = 1, #minePosTable, 1 do
    ...
    mine:RemoveAbility("dummy_unit")
    mine:RemoveModifierByName("dummy_unit")
...
function Seafortress:DefeatFinalBoss(position)
  Timers:CreateTimer(5, function()
    local mithrilReward = SEA_FORTRESS_MITHRIL_VALDUN * Events.ResourceBonus
