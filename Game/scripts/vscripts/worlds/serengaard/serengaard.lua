...
function Serengaard:SubmitStats()
        local url = ""
        print("STEAM ID:")
        print(PlayerResource:GetSteamID(MAIN_HERO_TABLE[1]:GetPlayerOwnerID()))
