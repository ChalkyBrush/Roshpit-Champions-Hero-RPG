...
function autumn_mist_cave_die()
    ...
    if Redfall.AutumnMistCanyonWavesCounters[currentWave]["killed"] == math.floor(Redfall.AutumnMistCanyonWavesCounters[currentWave]["total"] * killedTreshold) then
	    if currentWave == 1 then
			Redfall.AutumnMistCanyonWavesCounters[2]["killed"] = 0
			Redfall.AutumnMistCanyonWavesCounters[2]["total"] = 13 + 13 + 13
            for i = 1, #spawnPositionTable, 1 do
                if i == 2 then
                    Redfall:SpawnCaveWaveUnit("redfall_troll_warlord", spawnPositionTable[i], 2, 13, delay, true)
                elseif i == 3 then
                    Redfall:SpawnCaveWaveUnit("redfall_ashfall_knight", spawnPositionTable[i], 2, 13, delay, true)
                else
                    Redfall:SpawnCaveWaveUnit("redfall_mist_knight", spawnPositionTable[i], 2, 13, delay, true)
                end
            end
        elseif currentWave == 2 then
			Redfall.AutumnMistCanyonWavesCounters[3]["killed"] = 0
			Redfall.AutumnMistCanyonWavesCounters[3]["total"] = 13 + 13 + 13
            for i = 1, #spawnPositionTable, 1 do
                if i == 1 then
                    Redfall:SpawnCaveWaveUnit("redfall_canyon_bull", spawnPositionTable[i], 3, 13, delay, true)
                elseif i == 2 then
                    Redfall:SpawnCaveWaveUnit("redfall_troll_warlord", spawnPositionTable[i], 3, 13, delay, true)
                else
                    Redfall:SpawnCaveWaveUnit("redfall_mist_knight", spawnPositionTable[i], 3, 13, delay, true)
                end
            end
        elseif currentWave == 3 then
			Redfall.AutumnMistCanyonWavesCounters[4]["killed"] = 0
			Redfall.AutumnMistCanyonWavesCounters[4]["total"] = 13 + 13 + 13
            for i = 1, #spawnPositionTable, 1 do
                if i == 1 then
                    Redfall:SpawnCaveWaveUnit("redfall_canyon_bull", spawnPositionTable[i], 4, 13, delay, true)
                elseif i == 2 then
                    Redfall:SpawnCaveWaveUnit("redfall_troll_warlord", spawnPositionTable[i], 4, 13, delay, true)
                else
                    Redfall:SpawnCaveWaveUnit("redfall_mist_assassin", spawnPositionTable[i], 4, 13, delay, true)
                end
            end
        elseif currentWave == 4 then
			Redfall.AutumnMistCanyonWavesCounters[5]["killed"] = 0
			Redfall.AutumnMistCanyonWavesCounters[5]["total"] = 13 + 13 + 13
            for i = 1, #spawnPositionTable, 1 do
                if i == 1 then
                    Redfall:SpawnCaveWaveUnit("redfall_troll_warlord", spawnPositionTable[i], 5, 13, delay, true)
                elseif i == 2 then
                    Redfall:SpawnCaveWaveUnit("redfall_mist_knight", spawnPositionTable[i], 5, 13, delay, true)
                else
                    Redfall:SpawnCaveWaveUnit("redfall_mist_assassin", spawnPositionTable[i], 5, 13, delay, true)
                end
            end
        elseif currentWave == 5 then
			Redfall.AutumnMistCanyonWavesCounters[6]["killed"] = 0
			Redfall.AutumnMistCanyonWavesCounters[6]["total"] = 13 + 13 + 13
            for i = 1, #spawnPositionTable, 1 do
                if i == 1 then
                    Redfall:SpawnCaveWaveUnit("redfall_hooded_soul_reacher", spawnPositionTable[i], 6, 13, delay, true)
                elseif i == 2 then
                    Redfall:SpawnCaveWaveUnit("redfall_mist_assassin", spawnPositionTable[i], 6, 13, delay, true)
                else
                    Redfall:SpawnCaveWaveUnit("redfall_ashfall_knight", spawnPositionTable[i], 6, 13, delay, true)
                end
            end
...
function redfall_priestess_of_ashara_die(event)
