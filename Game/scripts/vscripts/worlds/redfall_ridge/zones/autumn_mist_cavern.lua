function Redfall:InitializeAutumnMistCanyon()
	Redfall.AutumnMistCanyon = {}
	Redfall.AutumnMistCanyon.active = true
...
function Redfall:SpawnSpiritOfAshara(position, fv)
	...
	local unit = Spawning:SpawnUnit{
		unitName = "redfall_priestess_of_ashara",
		spawnPoint = position,
		minDrops = 2,
		maxDrops = 4,
		itemLevel = 37,
		...
		fv = fv,
		isAggro = false,
		deathModifier = "modifier_redfall_priestess_of_ashara_die",
