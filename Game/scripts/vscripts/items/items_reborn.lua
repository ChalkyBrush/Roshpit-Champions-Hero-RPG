...
RPCItems.PotionsDrops[ENEMY_TYPE_WEAK_CREEP][0] = 99
RPCItems.PotionsDrops[ENEMY_TYPE_WEAK_CREEP][1] = 100
RPCItems.PotionsDrops[ENEMY_TYPE_NORMAL_CREEP][0] = 96
RPCItems.PotionsDrops[ENEMY_TYPE_NORMAL_CREEP][1] = 99
RPCItems.PotionsDrops[ENEMY_TYPE_NORMAL_CREEP][2] = 100
RPCItems.PotionsDrops[ENEMY_TYPE_ELITE_CREEP][0] = 55
...
RPCItems.SOCKETS_ON_DROP_CHANCE[1] = 10
...
RPCItems.REGULAR_PROPERTIES[RPC_GEAR_SLOT_WEAPON] = {"strength", "agility", "intelligence", "spirit", "base_ability", "item_damage", "armor_pierce", "spell_pierce", "t1_rune", "t2_rune", "t3_rune", "t1_rune", "t2_rune", "t3_rune"}
...
RPCItems.PROPERTY_COLORS["strength"] = ROSHPIT_ATTRIBUTE_STRENGTH_COLOR
RPCItems.PROPERTY_COLORS["agility"] = ROSHPIT_ATTRIBUTE_AGILITY_COLOR
RPCItems.PROPERTY_COLORS["intelligence"] = ROSHPIT_ATTRIBUTE_INTELLIGENCE_COLOR
RPCItems.PROPERTY_COLORS["spirit"] = ROSHPIT_ATTRIBUTE_SPIRIT_COLOR
