...
function RPCItems:RollBodyProperty1(item, xpBounty, randomHelm)
    ...
    elseif luck >= 50 and luck < 60 then
        ...
        RPCItems:SetPropertyValues(item, value, "#item_physical_block", "#B02020",  1)
    elseif luck >= 60 and luck < 70 then
        ...
        RPCItems:SetPropertyValues(item, value, "#item_magic_block", "#343EC9",  1)   
...
function RPCItems:RollBodyProperty2(item, xpBounty)
    ...
    elseif luck >= 40 and luck < 50 then
    	local bonus = RPCItems:GetHeadBonusRoll(randomHelm, 3, 6)
        value, prefixLevel = RPCItems:RollAttribute(xpBounty, 1, 4+bonus, 0, 0, item.rarity, false, maxFactor*4)
    ...
    elseif luck >= 50 and luck < 60 then
        ...
        RPCItems:SetPropertyValues(item, value, "#item_physical_block", "#B02020",  2)
    elseif luck >= 60 and luck < 70 then
    	local bonus = 0
        ...
        RPCItems:SetPropertyValues(item, value, "#item_magic_block", "#343EC9",  2)     
    elseif luck >= 70 and luck < 80 then
    	local bonus = RPCItems:GetHeadBonusRoll(randomHelm, 2, 4)
...
function RPCItems:RollBodyProperty3(item, xpBounty)
    ...
    elseif luck >= 40 and luck < 50 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 2, 6, 0, 0, item.rarity, false, maxFactor*5)
    ...
    elseif luck >= 50 and luck < 60 then
        ...
        RPCItems:SetPropertyValues(item, value, "#item_physical_block", "#B02020",  3)
    elseif luck >= 60 and luck < 70 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 1, 20, 0, 0, item.rarity, false, maxFactor*20)
        RPCItems:SetPropertyValues(item, value, "#item_magic_block", "#343EC9",  3)   
    elseif luck >= 70 and luck < 80 then
    ...
    elseif luck >= 90 and luck < 100 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 1, 10, 0, 0, item.rarity, false, math.ceil(maxFactor/5))
...
function RPCItems:RollBodyProperty4(item, xpBounty)
   ...
   local maxFactor = RPCItems:GetMaxFactor()
    ...
    elseif luck >= 40 and luck < 50 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 1, 6, 0, 0, item.rarity, false, maxFactor*5)
        RPCItems:SetPropertyValues(item, value, "#item_armor", "#D1D1D1",  4)
    elseif luck >= 50 and luck < 60 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 1, 70, 0, 0, item.rarity, false, maxFactor*20)
        RPCItems:SetPropertyValues(item, value, "#item_physical_block", "#B02020",  4)
    elseif luck >= 60 and luck < 70 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 1, 20, 0, 0, item.rarity, false, maxFactor*20)
        RPCItems:SetPropertyValues(item, value, "#item_magic_block", "#343EC9",  4)  
    elseif luck >= 70 and luck < 80 then
    ...
    elseif luck >= 90 and luck < 100 then
        value, nameLevel = RPCItems:RollAttribute(xpBounty, 1, 10, 0, 0, item.rarity, false, math.ceil(maxFactor/4.7))
