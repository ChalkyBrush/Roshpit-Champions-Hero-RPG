...
local itemClass = item_rpc_twisted_purple_mask_of_ahnqhir
local itemClassName = 'item_rpc_twisted_purple_mask_of_ahnqhir'

modifier_twisted_purple_mask_of_ahnqhir = class(npc_base_modifier, nil, npc_base_modifier)
local modifierClass = modifier_twisted_purple_mask_of_ahnqhir
local modifierName = 'modifier_twisted_purple_mask_of_ahnqhir'
LinkLuaModifier(modifierName, "items/lua/helm/twisted_purple_mask_of_ahnqhir", LUA_MODIFIER_MOTION_NONE)

function itemClass:GetClassName()
    return itemClassName
end
function itemClass:GetName()
    return "Twisted Purple Mask of Ahn'Qhir"
end
...
function modifierClass:OnIntervalThink()
	...
	local pointAbility = self:GetParent():GetAbilityByIndex(DOTA_Q_SLOT)
...
function modifierClass:GetRoshpitPctCdRed()
    return TWISTED_MASK_OF_AHNQHIR_PURPLE_CD_RED_PCT
end
