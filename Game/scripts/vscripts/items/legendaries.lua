...
function RPCItems:RollChampionsGearMail(item_level)
    ...
    RPCItems:RollBasicItemProperty(item, item_slot, 1, item_level, "rune_r_4", 1)
    RPCItems:RollBasicItemProperty(item, item_slot, 2, item_level, nil, 1)
    RPCItems:RollBasicItemProperty(item, item_slot, 3, item_level, nil, 1)
    RPCItems:RollBasicItemProperty(item, item_slot, 4, item_level, nil, 1)
...
function RPCItems:GetWorldDropImmortalNamesList(gear_slot)
    ...
    elseif gear_slot == RPC_GEAR_SLOT_BODY then
        itemsList = {"item_rpc_armor_of_secret_temple", "item_rpc_armor_of_violet_guard", "item_rpc_avalanche_plate", "item_rpc_bladestorm_vest", "item_rpc_bluestar_armor", "item_rpc_dark_arts_vestments"}
    end
    return itemsList
end
