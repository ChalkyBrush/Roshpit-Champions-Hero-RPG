...
function RPCItems:GetWorldDropImmortalNamesList(gear_slot)
    ...
    elseif gear_slot == RPC_GEAR_SLOT_GLOVES then
        ...
        "item_rpc_magebane_gloves", "item_rpc_malachite_shade_bracer", "item_rpc_marauder_gloves", "item_rpc_master_gloves", "item_rpc_mordiggus_gauntlet", "item_rpc_mountain_vambraces"}
    end
    return itemsList
end
