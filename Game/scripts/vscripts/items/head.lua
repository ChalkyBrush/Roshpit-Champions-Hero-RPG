...
function Head:action(propertyName, propertyValue, hero, inventory_unit, head_ability, item)
	...
	elseif propertyName == "mask_of_ahnqir" then
		Head:addItemModifier(0, hero, inventory_unit, "modifier_mask_of_ahnqhir", item)
	end
	hero.headItem = item
end
