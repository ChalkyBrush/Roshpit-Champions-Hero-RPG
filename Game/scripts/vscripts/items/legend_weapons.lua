...
function Weapons:RollLegendWeapon1(deathLocation, class, strictMaxItemLevel, disableDrop)
	...
	local weapon = Weapons:CreateWeaponVariant("item_rpc_jex_immortal_weapon_2_a", rarity, "", "weapon", true, "Slot: Weapon", "npc_dota_hero_arc_warden", maxLevel, 100)
	...
	if internalName == "conjuror" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#item_aspect_health", "#3D82CC",  1) 
		local value = RandomInt(1, RandomInt(1, Arena.PitLevel))
		RPCItems:SetPropertyValues(weapon, value, "#item_base_ability", "#7AB4CC",  2)
	elseif internalName == "flamewaker" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#item_strength", "#CC0000",  2)
	elseif internalName == "voltex" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#item_bonus_attack_damage", "#343EC9",  2) 		
	...
	elseif internalName == "astral" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#item_all_attributes", "#FFFFFF",  2)
	...
	elseif internalName == "sorceress" then
		local value = RandomInt(1, RandomInt(1, Arena.PitLevel))
		RPCItems:SetPropertyValues(weapon, value, "#item_base_ability", "#7AB4CC",  1)  
		local value = Weapons:GetDeviation(17+RandomInt(1,Arena.PitLevel*3), rarityFactor)
		RPCItems:SetPropertyValues(weapon, value, "#item_intelligence", "#33CCFF",  2)
	elseif internalName == "seinaru" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#item_agility", "#2EB82E",  2)
	...
	elseif internalName == "trapper" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#item_bonus_attack_damage", "#343EC9",  1) 
		local value = RandomInt(1, RandomInt(1, Arena.PitLevel))
		RPCItems:SetPropertyValues(weapon, value, "#item_base_ability", "#7AB4CC",  2)  
	...
	RPCItems:SetPropertyValues(weapon, value, propertyTable[specialProperty1], colorTable[specialProperty1],  3)

	local value = Weapons:GetDeviation(baseValueTable[specialProperty2]+RandomInt(1, Arena.PitLevel*2), rarityFactor)
	RPCItems:SetPropertyValues(weapon, value, propertyTable[specialProperty2], colorTable[specialProperty2],  4)
...
function Weapons:RollLegendWeapon2(deathLocation, class, strictMaxItemLevel, disableDrop)
	...
	elseif internalName == "voltex" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#item_all_attributes", "#FFFFFF",  1)
	...
	elseif internalName == "axe" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_NORMAL, color,  2)
	elseif internalName == "astral" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#item_critical_strike", "#CC3D3D",  2)
	elseif internalName == "epoch" then
	...
	elseif internalName == "paladin" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_HOLY, color,  2) 
	elseif internalName == "sorceress" then
	...
	elseif internalName == "seinaru" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_WIND, color,  2) 
	elseif internalName == "warlord" then
	...
	elseif internalName == "duskbringer" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_GHOST, color,  2) 
	elseif internalName == "auriun" then
	...
	elseif internalName == "spirit_warrior" then
		...
		if luck == 1 then
			weapon.property1name = "intelligence"
			RPCItems:SetPropertyValues(weapon, value, "#item_intelligence", "#33CCFF", 1)
		elseif luck == 2 then
			weapon.property1name = "strength"
			RPCItems:SetPropertyValues(weapon, value, "#item_strength", "#CC0000", 1)
		elseif luck == 3 then
			weapon.property1name = "agility"
			RPCItems:SetPropertyValues(weapon, value, "#item_agility", "#2EB82E",  1)
		end		   
		local luck = RandomInt(1,3)
		...
		if luck == 1 then
			...
			RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_FIRE, color,  2) 
		elseif luck == 2 then
			local name, color = Elements:GetElementNameAndColorByCode(RPC_ELEMENT_WIND)
			RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_WIND, color,  2) 
		elseif luck == 3 then
			local name, color = Elements:GetElementNameAndColorByCode(RPC_ELEMENT_WATER)
			RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_WATER, color,  2) 
		end
	elseif internalName == "mountain_protector" then
	...
	elseif internalName == "chernobog" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_DEMON, color,  2) 
	elseif internalName == "solunia" then
	...
	elseif internalName == "zonik" then
		local value = RandomInt(1, 3)
		RPCItems:SetPropertyValues(weapon, value, "#item_movespeed", "#B02020",  1)
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_TIME, color, 2) 
	elseif internalName == "arkimus" then
...
function Weapons:RollLegendWeapon3(deathLocation, class, strictMaxItemLevel, disableDrop)
	...
	elseif internalName == "venomort" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_POISON, color,  2) 
	elseif internalName == "axe" then
	...
	elseif internalName == "astral" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_COSMOS, color,  2) 	
	elseif internalName == "epoch" then
	...
	elseif internalName == "auriun" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_SHADOW, color,  2) 
	elseif internalName == "trapper" then
	...
	elseif internalName == "mountain_protector" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_EARTH, color,  2) 
	elseif internalName == "chernobog" then
	...
	elseif internalName == "ekkan" then
		...
		RPCItems:SetPropertyValues(weapon, value, "#rpc_item_element"..RPC_ELEMENT_UNDEAD, color,  2)  
	elseif internalName == "zonik" then
