...
function Precache:WinterCastle()
	local unitTable = {"winterblight_diviner_horus", "winterblight_castle_warrior", "winterblight_castle_watchman", "winterblight_skull_ripper", "winterblight_elite_ghoul", "winterblight_elite_castle_warrior", "winterblight_grave_skeleton", "winterblight_cellar_spider_mother", "winterblight_spider_egg_sack",  "winterblight_egg_spider", "winterblight_invading_spider", "winterblight_ice_harbor_mini_boss",  "winterblight_spike_trap", "winterblight_ground_blade", "winterblight_corrupted_corpse", "winterblight_bloodripper", "winterblight_torturer",  "winterblight_ghost_pirate", "winterblight_castle_shadow_of_saturn", "winterblight_saturn_zealot", "winterblight_slime_goblin", "winterblight_fallen_one", "winterblight_armory_rock", "winterblight_sun_rubble", "winterblight_ice_bear", "winterblight_gold_fanatic", "winterblight_treasure_room_tower", "winterblight_treasure_zombie", "winterblight_treasure_chest", "winterblight_castle_graviton", "winterblight_moon_warden", "winterblight_blue_slime_monster", "winterblight_slime_zombie", "winterblight_castle_boss", "winterblight_blue_goo_gunman"}
	local i = 1 
	local function precache_function()
		--print("done precaching: "..unitTable[i])
		i = i+1
