function showBossHealth(msg) {
	...
	if ($('#boss_health_outer').BHasClass('invisible') || $('#boss_id').text === bossId) {
		...
		$('#boss_id').text = bossId;
	} else if ($('#boss_health_outer2').BHasClass('invisible') || $('#boss_id2').text === bossId) {
	...
	} else if ($('#boss_health_outer3').BHasClass('invisible') || $('#boss_id3').text === bossId) {
	...
	} else if ($('#boss_health_outer4').BHasClass('invisible') || $('#boss_id4').text === bossId) {
	...
	} else if ($('#boss_health_outer5').BHasClass('invisible') || $('#boss_id5').text === bossId) {
